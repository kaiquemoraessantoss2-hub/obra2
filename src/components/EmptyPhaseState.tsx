...
export function getTemplatePhases(): ConstructionPhase[] {
  ...
  const template: ConstructionPhase[] = [
    ...
    { id: newId(), name: 'ALVENARIA', icon: 'Box', color: 'bg-orange-500', progress: 0, status: 'NOT_STARTED', weight: 15, startDate: '', endDate: '', responsible: '', observations: '', subSteps: [
    ...
    { id: newId(), name: 'INSTALAÇÕES', icon: 'Zap', color: 'bg-cyan-500', progress: 0, status: 'NOT_STARTED', weight: 10, startDate: '', endDate: '', responsible: '', observations: '', subSteps: [
    ...
    { id: newId(), name: 'ESQUADRIAS', icon: 'Layers', color: 'bg-indigo-500', progress: 0, status: 'NOT_STARTED', weight: 8, startDate: '', endDate: '', responsible: '', observations: '', subSteps: [
    ...
    { id: newId(), name: 'REVESTIMENTO', icon: 'Droplets', color: 'bg-rose-500', progress: 0, status: 'NOT_STARTED', weight: 15, startDate: '', endDate: '', responsible: '', observations: '', subSteps: [
    ...
    { id: newId(), name: 'PINTURA', icon: 'CheckCircle', color: 'bg-teal-500', progress: 0, status: 'NOT_STARTED', weight: 5, startDate: '', endDate: '', responsible: '', observations: '', subSteps: [
    ...
    { id: newId(), name: 'COMPLEMENTOS', icon: 'Users', color: 'bg-violet-500', progress: 0, status: 'NOT_STARTED', weight: 2, startDate: '', endDate: '', responsible: '', observations: '', subSteps: [
